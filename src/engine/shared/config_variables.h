...
MACRO_CONFIG_STR(SvName, sv_name, 128, "Original BlmapChill ~ Block & Relax", CFGFLAG_SAVE|CFGFLAG_SERVER, "Server name", AUTHED_ADMIN)
...
MACRO_CONFIG_INT(SvTestingCommands, sv_test_cmds, 1, 1, 1, CFGFLAG_SERVER, "Turns testing commands aka cheats on/off", AUTHED_ADMIN)
